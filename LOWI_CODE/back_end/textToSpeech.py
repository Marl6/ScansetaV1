...
# Get API credentials
user_id = os.getenv("PLAY_HT-CER_USER_ID")
api_key = os.getenv("PLAY_HT-CER_API_KEY")
...
options = TTSOptions(voice="s3://voice-cloning-zero-shot/f4675629-5070-4a4a-8c61-eaea49ca8ec9/original/manifest.json")
