...
completion = client.chat.completions.create(
    model="gpt-4o-mini",
    messages=[
        {"role": "system", "content": "You are a helpful pharmacist. Always respond concisely in two sentences."},
        {"role": "user", "content": user_input}
    ],
    temperature=0.7,  # Adjust temperature for more controlled responses
    max_tokens=50  # Limiting response length to approximately 2 sentences
)
